...
then 
  ...
  PARLAY_NUM_THREADS=1 ./bazel-bin/kmeans_test_run -k 100 -i ../my_data/base.1B.u8bin.crop_nb_1000000 -f bin -t uint8 -D short -m 20 -two yes -csv_log true -csv_log_file_name experiment6/output/test_lazy_naive_100.csv -csv_log_file_name2 experiment6/output/test_lazy_yy_100.csv
