...
then 
  ...
  ./bazel-bin/kmeans_test_run -k 100 -i ../my_data/base.1B.u8bin.crop_nb_1000000 -f bin -t uint8 -D short -m 20 -two yes -csv_log true -csv_log_file_name experiment4/output/test_lazy_naive_100.csv -csv_log_file_name2 experiment4/output/test_lazy_yy_100.csv
  ...
  # python3 include/utils/comparative_time_graphs.py < experiment4/comparative_plot_testing_input.txt

  # python3 include/utils/graph_bench2.py < experiment4/naive_iter_input.txt

  # python3 include/utils/graph_bench2.py < experiment4/yy_iter_input.txt
