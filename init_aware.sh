...
./bazel-bin/init_test_run -k 100000 -i /ssd1/data/MSSPACEV1B/spacev1b_base.i8bin -f bin -t uint8 -D Euclidean -c Lazy

./bazel-bin/init_test_run -k 100000 -i /ssd1/data/MSSPACEV1B/spacev1b_base.i8bin -f bin -t uint8 -D Euclidean -c LSH
